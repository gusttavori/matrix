    ...
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <form onSubmit={handleSubmit}>
        <Card title="Dados da Rede / Prefeitura" style={{ marginBottom: '1.5rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
            <div style={{ gridColumn: '1 / -1' }}>
              <Input id="networkName" label="Nome da Rede (Ex: Prefeitura Municipal de São Paulo)" value={formData.networkName} onChange={handleChange} required />
            </div>
        ...
        <Card title="Acesso do Secretário (Gestor da Rede)" style={{ marginBottom: '1.5rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
            <div style={{ gridColumn: '1 / -1' }}>
              <Input id="adminName" label="Nome Completo do Gestor" value={formData.adminName} onChange={handleChange} required />
            </div>
            <Input id="adminEmail" type="email" label="E-mail de Acesso" value={formData.adminEmail} onChange={handleChange} required />
          ...
          <p style={{ fontSize: '0.875rem', color: 'var(--text-secondary)', marginTop: '1rem' }}>
            * O Secretário será forçado a trocar esta senha no primeiro login por questões de segurança.
          </p>
        </Card>
